   <div class="mt-5">
           ...
           <div class="w-3/5 flex flex-col pl-5">
               <div class="w-full p-6 rounded-sm shadow-sm bg-gray-100">
                   ...
                   <div class="w-full  flex justify-between items-center ">
                       <h1 class="font-semibold ">LIST OF SELECTED HOD's</h1>
                   ...
                   <tbody>
                       ...
                       <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                           <td class="px-6 py-4 flex justify-center items-center">
                               ...
                               <div class="h-16 w-16 rounded-full bg-gray-700 flex justify-center items-center">

                                   <h1 class="text-white uppercase text-lg">{{$this->getNameInitials($user['name'])}}</h1>
       ...
       <x-jet-confirmation-modal wire:model="openSearchModal">
           ...
           <x-slot name="icon">
               <div class="mx-auto shrink-0 flex h-12 w-12 rounded-full bg-green-100 sm:mx-0 sm:h-10 sm:w-10">
           ...
           <x-slot name="content">
               ...
               <div class="py-5 pr-10">
                   <div class="border border-zinc-200 w-full mr-4 mb-3 rounded-sm">
                   ...
                   <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                       ...
                       <tbody>
                           ...
                           <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                               ...
                               <td class="px-6 py-4 flex">
                                   <x-jet-button class="bg-blue-500 hover:bg-blue-700" wire:click="addHOD({{$user['id']}})">
                                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                           <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
                                       </svg>
