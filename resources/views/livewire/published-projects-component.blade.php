    ...
    <div class="grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-1 grid-flow-row gap-4 mt-5">
        ...
        <div class="border-0 border-emerald-300 bg-gray-100 rounded-lg flex flex-col flex-center shadow-lg">
            <div class="overflow-hidden h-32 rounded-t-lg relative">
                ...
                <img src="./assets/images/projects/banner3.jpg" class="w-full h-32 object-cover" />
            </div>
            ...
            <div class="py-1 ">
                ...
                <div class="flex justify-center mt-3 flex-col items-center text-xs text-gray-500">
                    ...
                    <span class="mb-3"> Division -1 (NIC Punjab)</span>
                    <h1 class="font-semibold uppercase text-xs text-gray-700 text-center">
                        HOD Name
                    </h1>
                    <span class="mb-3">Mukesh Kumar Ralli</span>
                ...
                <div class="mt-4">
                    <div class="flex justify-center text-sm bg-gray-200 w-full p-3 ">
                        <a href="#" class="text-gray-500 hover:text-gray-800">More details</a>
                    </div>
