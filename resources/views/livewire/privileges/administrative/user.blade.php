<div class="bg-gray-50 p-4 rounded-md">
    <div class="flex justify-between">
        <x-sub-title class="font-semibold">User Privileges</x-sub-title>
    ...
    <div>
            ...
            <form>
                <div class="flex">
                    <div class="flex items-center h-5">
                        <input id="helper-checkbox-u.{{ $prv->id }}" wire:model="mappedPrivileges.{{ $prv->id }}" aria-describedby="helper-checkbox-text" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="ml-2 text-sm">
                        <label for="helper-checkbox-u.{{ $prv->id }}" class="font-medium font-semibold text-gray-900 dark:text-gray-300">{{$prv->name}}</label>
        ...
        <div class="flex justify-end mt-4">
            ...
            <div class="flex justify-end">
                <x-jet-action-message class="mr-3 mt-3 text-gray-400 flex" on="saved">
                    ...
                    {{ __('User privileges updated successfully...') }}
