<div>
    ...
    <div class="mt-10 flex flex-wrap">
        <div class="w-2/5 flex flex-col justify-center items-center bg-pink-50 rounded-sm">
            <h1 class="text-9xl text-pink-900 font-inter ">
                @if($allgroups->total()<10) <span>0{{$allgroups->total()}}</span>
                    @else
                    <span>{{$allgroups->total()}}</span>
                    @endIf
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex">
                            ...
                            <x-jet-danger-button wire:click="openGroupForDeletion({{$group['id']}})">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
    ...
    <x-jet-confirmation-modal wire:model="confirmingGroupDeletion">
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="toggle('Deletion')" wire:loading.attr="disabled">
                Cancel
