...
<div>
    ...
    <div class=" flex justify-between ">
     ...
     <br />
       ...
       <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"><td class="px-6 py-3">{{ $division->name}}</td><td class="px-6 py-3">{{ $division->group->name}}</td><td class="px-6 py-3">
