            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 flex">
                        <a href="/admin/manual/{{$man->id}}" wire:click="toggle('editmode')" class="pointer mr-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 stroke-sky-800 hover:stroke-sky-600 ">
    ...
    <x-slot name="content">
        ...
        <div class="w-full flex justify-center items-center p-5">
            ...
            <ul class="grid grid-cols-1 gap-2 w-full">
                ...
                @foreach($currentFeatureBox->featureboxentries->groupBy('title') as $key=>$x)
