    ...
    <div class="rounded w-full mx-auto mt-4">
        ...
        <div class="bg-purple-100 rounded">
            <ul id="tabs" class="inline-flex px-1 w-full">
                <li class="flex px-4 py-4 text-gray-500 text-sm  py-3  border-b-2 border-fuchsia-800 text-fuchsia-800 bg-purple-200 -mb-px">
        ...
        <!-- Tab Contents -->
        <div id="tab-contents">
            <div id="first" class=" mt-2 text-gray-600 rounded p-4">
        ...
        tabTogglers.forEach(function(toggler) {
            toggler.addEventListener("click", function(e) {
                ...
                for (let i = 0; i < tabContents.children.length; i++) {
                    ...
                    tabTogglers[i].parentElement.classList.remove("border-b-2", "border-fuchsia-800", "text-fuchsia-800", "bg-purple-200", "-mb-px");
                ...
                e.target.parentElement.classList.add("border-b-2", "border-fuchsia-800", "text-fuchsia-800", "bg-purple-200", "-mb-px");
            });
        });
