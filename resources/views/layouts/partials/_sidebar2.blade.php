...
<aside class="w-72" aria-label="Sidebar">
    <div class="min-h-screen overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        <ul class="space-y pl-2">
            ...
            <li>
                <button type="button" class="flex items-center w-full p-2 pl-3 py-3 text-base font-normal text-gray-900 transition duration-75  group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    ...
                    <span class="flex-1 ml-2 text-left whitespace-nowrap" sidebar-toggle-item>Division Management</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <div class="px-6">
                        <x-jet-nav-link href="{{ route('divisions') }}" :active="request()->routeIs('divisions')">
                            <svg class="w-6 h-6 mr-2 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
