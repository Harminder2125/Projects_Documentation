...
<aside class="w-72" aria-label="Sidebar">
    <div class="min-h-screen h-full overflow-y-auto bg-gray-50 shadow-2xl dark:bg-gray-800">
        <div class="h-16 bg-fuchsia-900 mb-5 flex justify-center items-center">
            <h1 class="text-sm uppercase font-semibold text-white">project manual repository</h1>
        </div>
        ...
        <div class="pl-2 mt-14">
            ...
            <div class="flex flex-col pb-5 pl-4">
                ...
                <p class="uppercase text-sm font-semibold mb-1 text-gray-700">{{ Auth::user()->name }}</p>
                <p class="text-xs text-gray-400 uppercase">{{ Auth::user()->designation }}</p>
        ...
        <ul class="space-y pl-2">
            <li>
                ...
                <x-jet-nav-link class="text-sm border-b border-gray-200 uppercase" href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
            ...
            <li>
                ...
                <x-jet-nav-link class="border-b text-sm border-gray-200 uppercase" href="{{ route('adminusers') }}" :active="request()->routeIs('adminusers')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
            ...
            <li class="border-b border-gray-200">
                <button type="button" class="flex items-center w-full p-2 pl-3 py-3 text-sm font-normal text-gray-500 transition duration-75  group hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example2" data-collapse-toggle="dropdown-example2">
                    ...
                    <span class="flex-1 text-xs font-semibold uppercase ml-2 text-left whitespace-nowrap" sidebar-toggle-item>Priveleges Management</span>
                ...
                <ul id="dropdown-example2" class="hidden">
                    <li>
                        <div class="pl-6">
                            ...
                            <x-jet-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('admin-priveleges') }}" :active="request()->routeIs('admin-priveleges')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
                    ...
                    <li>
                        <div class="pl-6">
                            ...
                            <x-jet-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('project-priveleges') }}" :active="request()->routeIs('project-priveleges')">
                ...
                <ul id="dropdown-example3" class="hidden">
                    ...
                    <li>
                        <div class="pl-6">
                            ...
                            <x-jet-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('createproject') }}" :active="request()->routeIs('createproject')">
    ...
    <li class="border-b border-gray-200">
        <button type="button" class="flex items-center w-full p-2 pl-3 py-3 text-sm font-normal text-gray-500 transition duration-75  group hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" w-6 h-6">
            ...
            <span class="flex-1 text-xs font-semibold uppercase ml-2 text-left whitespace-nowrap" sidebar-toggle-item>Teams Management</span>
            <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
            </svg>
        </button>
        <ul id="dropdown-example" class="hidden">
            <li>
                <div class="pl-6">
                    ...
                    <x-jet-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('team') }}" :active="request()->routeIs('team')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6z" />
                        </svg>
    ...
    <li>
        ...
        <x-jet-nav-link class="border-b text-sm border-gray-200 uppercase" href="{{ route('team') }}" :active="request()->routeIs('team')">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
