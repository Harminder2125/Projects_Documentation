        ...
        <div class="border-2 border-gray-200 border-dashed p-4">
            ...
            <div class="border-2 border-gray-200 border-dashed p-4">
                <<<<<<< HEAD <div class="flex">
                    <div>
                        =======
                        <x-main-title>{{ $featurebox[2]->title }}</x-main-title>
                        <x-sub-title class="h-8">{{ $featurebox[2]->subtitle }}</x-sub-title>
                ...
                <<<<<<< HEAD <div class="flex">
                    <div class="flex justify-center items-center">
                        <svg viewBox="0 0 512 512" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="h-8 w-8 mr-2 fill-rose-800">
                            =======
                            <x-main-title>{{ $featurebox[3]->title }}</x-main-title>
                            <x-sub-title class="h-8">{{ $featurebox[3]->subtitle }}</x-sub-title>
                            <div class="py-4 flex flex-col justify-center items-center ">
                    ...
                    <div class="border-2 border-gray-200 border-dashed p-4">
                        <<<<<<< HEAD <div class="flex">
                            <div class="flex justify-center items-center">
                                =======
                                <x-main-title>{{ $featurebox[4]->title }}</x-main-title>
                                <x-sub-title class="h-8">{{ $featurebox[4]->subtitle }}</x-sub-title>
                                <div class="py-4 flex flex-col justify-center items-center ">
                                    >>>>>>> 4bbe8ecc4f68630472c27e64459a0c402906e121
                    ...
                    <div class="border-2 border-gray-200 border-dashed p-4">
                        <<<<<<< HEAD <div class="flex">
                            <div class="flex justify-center items-center">
                                =======
                                <x-main-title>{{ $featurebox[5]->title }}</x-main-title>
                                <x-sub-title class="h-8">{{ $featurebox[5]->subtitle }}</x-sub-title>
                                <div class="py-4 flex flex-col justify-center items-center ">
                                    >>>>>>> 4bbe8ecc4f68630472c27e64459a0c402906e121
                    ...
                    <div class="flex-2 w-full border-2  border-gray-200 border-dashed p-4">
                        <div class="flex">
                            <div class="flex justify-center items-center">
                                ...
                                <<<<<<< HEAD <svg viewBox="0 0 512 512" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="h-8 w-8 mr-2">
                                    =======
                                    <x-main-title>{{ $featurebox[6]->title }}</x-main-title>
                                    <x-sub-title class="h-8">{{ $featurebox[6]->subtitle }}</x-sub-title>
                                    <div class="py-4 flex flex-col justify-center items-center ">
